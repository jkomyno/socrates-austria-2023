...
class NumericArrays {
    ...
    */
    get int32() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_int32(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set int32(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_int32(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get uint32() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_uint32(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set uint32(arg0) {
        const ptr0 = passArray32ToWasm0(arg0, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_uint32(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get uint64() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_uint64(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set uint64(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_uint64(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get int64() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_int64(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set int64(arg0) {
        const ptr0 = passArray64ToWasm0(arg0, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_int64(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get float() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_float(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set float(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_float(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    */
    get double() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_numericarrays_double(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set double(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_numericarrays_double(this.__wbg_ptr, ptr0, len0);
    }
}
...
class OptionalParams {
    ...
    */
    get int32() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_optionalparams_int32(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return r0 === 0 ? undefined : r1;
        } finally {
    ...
    */
    set int32(arg0) {
        wasm.__wbg_set_optionalparams_int32(this.__wbg_ptr, !isLikeNone(arg0), isLikeNone(arg0) ? 0 : arg0);
    }
    /**
...
class Scalars {
    ...
    */
    get n() {
        const ret = wasm.__wbg_get_scalars_n(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * In TS, the Rust `u32` is typed as `number`.
    ...
    */
    set n(arg0) {
        wasm.__wbg_set_scalars_n(this.__wbg_ptr, arg0);
    }
    /**
    ...
    */
    get id() {
        const ret = wasm.__wbg_get_scalars_id(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * In TS, the Rust `u64` is typed as `number`.
    ...
    */
    set id(arg0) {
        wasm.__wbg_set_scalars_id(this.__wbg_ptr, arg0);
    }
    /**
    * In TS, the Rust `char` is typed as `string`, and every character after the first one is truncated.
    * @returns {string}
    */
    get letter() {
        const ret = wasm.__wbg_get_scalars_letter(this.__wbg_ptr);
        return String.fromCodePoint(ret);
    }
    /**
    * In TS, the Rust `char` is typed as `string`, and every character after the first one is truncated.
    ...
    */
    set letter(arg0) {
        wasm.__wbg_set_scalars_letter(this.__wbg_ptr, arg0.codePointAt(0));
    }
    /**
    ...
    */
    get toggle() {
        const ret = wasm.__wbg_get_scalars_toggle(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * In TS, the Rust `bool` is typed as `boolean`.
    ...
    */
    set toggle(arg0) {
        wasm.__wbg_set_scalars_toggle(this.__wbg_ptr, arg0);
    }
    /**
...
class StringParams {
    ...
    */
    get id() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_stringparams_id(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    set id(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_stringparams_id(this.__wbg_ptr, ptr0, len0);
    }
}
